            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group {!!$errors->has('nom') ? 'is-invalid':'' !!}">
                            {!! Form::text('nom', null, ['class' => 'form-control' , 'placeholder'=>'nom']) !!} {!! $errors->first('nom' , '<span class="text-danger">:message</span>')!!}
                        </div>
                        <div class="form-group {!!$errors->has('prenom') ? 'is-invalid':'' !!}">
                            {!! Form::text('prenom', null, ['class' => 'form-control' , 'placeholder'=>'prenom']) !!} {!! $errors->first('prenom' , '<span class="text-danger">:message</span>')!!}
                        </div>
                        ...
                        {!! Form::submit('AJOUTER', ['class' => 'btn btn-primary']) !!} {!! Form::close() !!}
                    </div>
                </div>
            </div>
        </div>
