    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                        {!! Form::model($produit , ['method'=>'PUT','route'=>['produit.update' , 'produit' => $produit->id] , 'files'=>true]) !!}
                        ...
                        {!! Form::file('image', ['class' => 'btn btn-info']) !!} {!! $errors->first('image' , '<span class="text-danger">:message</span>')!!}
                        </div>

                        {!! Form::submit('MODIFIER', ['class' => 'btn btn-info']) !!} {!! Form::close() !!}
                    </div>
                </div>
            </div>
        </div>
